...
async function getData() {
    ...
    function FirstTable() {
        ...
        let primerContenedor = ` <table class="table  table-hover table-secondary  ">
        <thead>
            <tr>
                <th colspan="3" class="table table-dark text-white">Events statisctics</th>
            </tr>
            <tr>
    ...
    function secondTable() {
        let segundoContenedor = `<table class="table table-hover table-secondary">
      <thead>
        <tr>
            <th colspan="3" class="table table-dark text-white">Upcoming events statisctics by category</th>
        </tr>
    </thead>
    <tbody>
        <tr>
    ...
    function thirdTable() {
        let tercerContenedor = `<table class="table table-hover table-secondary">
        <thead>
          <tr>
  
              <th colspan="3" class="table table-dark text-white">Past Events statisctic by category</th>
